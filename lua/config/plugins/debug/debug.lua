...
return {
  ...
  config = function()
    ...
    -- Adiciona a configuração customizada de attach para seu serviço
    dap.adapters.python = {
      type = 'executable',
      command = 'python',
    ...
    dap.configurations.python = {
      {
        ...
        pathMappings = {
          {
            localRoot = '${workspaceFolder}/app', -- ou use vim.fn.getcwd() .. '/app' se preferir
            remoteRoot = '/code/app',
          },
        },
        justMyCode = false,
